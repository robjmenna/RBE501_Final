...
K1 = subs(0.5 * m1 * (v_m1.' * v_m1), [a1 d1], [50/2 330/2]);
K2 = subs(0.5 * m2 * (v_m2.' * v_m2), [a1 d1 a2], [50 330 330/2]);
K4 = subs(0.5 * m4 * (v_m4.' * v_m4), [a1 d1 a2 a3 d2], [50 330 330 35/2 335/2]);
K6 = subs(0.5 * m6 * (v_m6.' * v_m6), [a1 d1 a2 a3 d2 d3], [50 330 330 35 335 80/2]);
K_p = subs(0.5 * mp * (v_m6.' * v_m6), [a1 d1 a2 a3 d2 d3], [50 330 330 35 335 80]);

P1 = subs(m1 * g * T01(3,4), [a1 d1], [50/2 330/2]);
P2 = subs(m2 * g * T02(3,4), [a1 d1 a2], [50 330 330/2]);
P4 = subs(m4 * g * T04(3,4), [a1 d1 a2 a3 d2], [50 330 330 35/2 335/2]);
P6 = subs(m6 * g * T0f(3,4), [a1 d1 a2 a3 d2 d3], [50 330 330 35 335 80/2]);
Pp = subs(mp * g * T0f(3,4), [a1 d1 a2 a3 d2 d3], [50 330 330 35 335 80]);
fprintf('Finding L\n');
K = K1 + K2 + K4 + K6 + K_p;
P = P1 + P2 + P4 + P6 + Pp;
...
for i=1:last_index
    ...
    second_term = subs(C,[q dq ddq],...
        [path_1(1,i) path_2(1,i) path_3(1,i) path_4(1,i) path_5(1,i) path_6(1,i)...
        path_1(2,i) path_2(2,i) path_3(2,i) path_4(2,i) path_5(2,i) path_6(2,i)...
        path_1(3,i) path_2(3,i) path_3(3,i) path_4(3,i) path_5(3,i) path_6(3,i)]);
    
    third_term = subs(G, [q dq ddq g],...
        [path_1(1,i) path_2(1,i) path_3(1,i) path_4(1,i) path_5(1,i) path_6(1,i)...
        path_1(2,i) path_2(2,i) path_3(2,i) path_4(2,i) path_5(2,i) path_6(2,i)...
        path_1(3,i) path_2(3,i) path_3(3,i) path_4(3,i) path_5(3,i) path_6(3,i)...
        9.8]);
    Tau(1:6,i) = first_term + second_term + third_term;
