function Tau = generate_torque(path_1, path_2, path_3, path_4, path_5, path_6)
...
for i=1:last_index
    ...
    Tau(1:6,i) = vpa(subs(Tau_s,...
        [q dq ddq g a1 a2 a3 d1 d2 d3 m1 m2 m4 m6 mp],...
        ...
        9.8 50 330 35 330 335 80 (mt*0.2869) (mt*0.3763) (mt*(0.1713 + 0.1363)) (mt*0.0283) 0]));
end
end